...
#changing autocomplete behavior: show all + loop thruogh them 

bind '"\t":menu-complete'
bind '"\e[Z":menu-complete-backward'
#shift tab for cycling back, tab for cyling forwards 

#making autocomplete non case sensisitve 
if grep -q 'set completion-ignore-case On' ~/.inputrc
then 
	: #protip: colon is the pass command for bash 
else
